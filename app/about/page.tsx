  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <main className="max-w-xl m-3 md:m-8 z-50 space-y-8 border border-gray-700/50 rounded-xl p-5 sm:p-10 backdrop-blur-xl bg-black/80">
        <Link href="/">
          <Button variant="ghost" className="group hover:bg-gray-800/50 hover:text-white rounded-full px-4 py-2 duration-300 cursor-pointer">
            <BsArrowLeft className="ml-2 transform transition-transform duration-300 ease-out group-hover:-translate-x-3" />Back
          </Button>
        </Link>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="font-medium">Specialized Technician in Full-Stack Web Development – School EFET (2022–2024)</p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div>
                <p className="font-medium flex items-center gap-2 flex-wrap">
                  ...
                  <a href="https://www.weblinking.net/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 bg-sky-800/30 text-sky-300 px-3 py-1 rounded-full text-sm font-semibold hover:bg-sky-700/40 hover:scale-[1.05] transition duration-200">
              ...
              <div>
                <p className="font-medium flex items-center gap-2 flex-wrap">
                  ...
                  <a href="https://tecforge.ma/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 bg-emerald-800/30 text-emerald-300 px-3 py-1 rounded-full text-sm font-semibold hover:bg-emerald-700/40 hover:scale-[1.05] transition duration-200">
              ...
              <div>
                <p className="font-medium flex items-center gap-2 flex-wrap">
                  ...
                  <a href="https://agadir.ma/fr/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 bg-blue-800/30 text-blue-300 px-3 py-1 rounded-full text-sm font-semibold hover:bg-blue-700/40 hover:scale-[1.05] transition duration-200">
